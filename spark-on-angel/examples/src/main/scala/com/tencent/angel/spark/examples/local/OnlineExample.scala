...
object OnlineExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val dataType = params.getOrElse(MLCoreConf.ML_DATA_INPUT_FORMAT, "dummy")
    val features = params.getOrElse(MLCoreConf.ML_FEATURE_INDEX_RANGE, "148").toInt
    ...
    val numEpoch = params.getOrElse(MLCoreConf.ML_EPOCH_NUM, "200").toInt
