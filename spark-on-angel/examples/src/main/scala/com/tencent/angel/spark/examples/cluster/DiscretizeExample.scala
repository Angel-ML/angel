...
import com.tencent.angel.spark.ml.featureEngineering.Discretize.DiscreteJsonParser
...
object DiscretizeExample {
  ...
  def main(args: Array[String]) {
    ...
    //特征配置文件路径
    val featureConfName = params.getOrElse("user-files", null)
    val disBoundsPath = params.getOrElse("disBoundsPath", null)
