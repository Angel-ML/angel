...
import com.tencent.angel.spark.ml.featureEngineering.Scaler.ScalerJsonParser
...
object ScalerExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val scaleConfPath = params.getOrElse("user-files", null)
    ...
    val standardPath = params.getOrElse("standardPath", null)
