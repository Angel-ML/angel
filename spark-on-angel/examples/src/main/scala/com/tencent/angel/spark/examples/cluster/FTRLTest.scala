...
import com.tencent.angel.spark.ml.psf.ftrl.PCGFTRLPartitioner
...
object FTRLTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    opt.init(min, max + 1, -1, RowType.T_FLOAT_SPARSE_LONGKEY, new PCGFTRLPartitioner())
