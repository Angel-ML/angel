package com.tencent.angel.graph.model.neighbor.dynamic.psf.getbyte;
 ...
 * Sample the neighbor
 */
public class GetByteNbrs extends GetFunc {

  public GetByteNbrs(LongKeysGetParam param) {
    super(param);
  }
  ...
  public GetResult merge(List<PartitionGetResult> partResults) {
    ...
    for (PartitionGetResult result : partResults) {
      ...
      for (int i = 0; i < nodeIds.length; i++) {
        if (neighbors[i] != null) {
          byte[] nbrs = ((ByteArrayElement) neighbors[i]).getData();
