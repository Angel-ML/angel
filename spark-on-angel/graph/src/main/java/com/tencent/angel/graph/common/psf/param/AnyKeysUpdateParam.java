...
public class AnyKeysUpdateParam extends UpdateParam {

  /**
   * Node ids
   */
  private final IElement[] nodeIds;
  ...
  public AnyKeysUpdateParam(int matrixId, IElement[] nodeIds, IElement[] neighbors) {
    super(matrixId);
