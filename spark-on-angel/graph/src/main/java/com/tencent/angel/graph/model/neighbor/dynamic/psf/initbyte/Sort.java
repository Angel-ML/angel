 ...
 */
public class Sort extends UpdateFunc {

  /**
   * Create a new UpdateParam
   */
  public Sort(UpdateParam param) { super(param); }

  public Sort() { this(null); }

  public static class SortParam extends UpdateParam {
    /**
     ...
     */
    public SortParam(int matrixId, boolean updateClock) {
    ...
    @Override public List<PartitionUpdateParam> split() {
      ...
      for (int i = 0; i < size; i++) {
        partParamList.add(new SortPartitionParam(matrixId, partList.get(i), updateClock));
      }
  ...
  public static class SortPartitionParam extends PartitionUpdateParam {
    /**
     ...
     * @param updateClock the update clock
     */
    public SortPartitionParam(int matrixId, PartitionKey partKey, boolean updateClock) {
  ...
  public void partitionUpdate(PartitionUpdateParam partParam) {
    ...
    try {
      while (it.hasNext()) {
        ...
        ByteArrayElement ele = (ByteArrayElement) next.getValue();
        if (ele != null) {
          ele.trans();
        }
      }
