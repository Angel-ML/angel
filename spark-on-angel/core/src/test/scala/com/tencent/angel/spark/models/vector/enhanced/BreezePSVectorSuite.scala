...
class BreezePSVectorSuite extends PSFunSuite with SharedPSContext {
  ...
  private var _localVector1: IntDoubleVector = _
  private var _localVector2: IntDoubleVector = _
  private var _localVector3: IntDoubleVector = _
  ...
  test("canCopyBreezePSVector") {
    val temp = _brzVector2.copy

    assert(temp.id != _brzVector2.id)
    assertSameElement(temp, _localVector2.getStorage.getValues)
  }
  ...
  test("canSetInto") {
    ...
    assertSameElement(_brzVector1, _localVector2.getStorage.getValues)
  }
  ...
  test("canAxpy") {
    ...
    val result = _localVector1.getStorage.getValues.indices.map(i => _localVector1.get(i) + 0.1 * _localVector2.get(i))
  ...
  test("canAddInto") {
    ...
    val sum = _localVector2.getStorage.getValues.indices.map(i => _localVector2.get(i) + _localVector3.get(i))
  ...
  test("canAddIntoS") {
    ...
    val sum = _localVector2.getStorage.getValues.map(_ + 1.0)
    assertSameElement(_brzVector2, sum)
  }
  ...
  test("canSubIntoS") {
    ...
    val result = _localVector2.getStorage.getValues.map(_ - 1.0)
    assertSameElement(_brzVector2, result)
  }
  ...
  test("negFromScale") {
    ...
    val result = _localVector2.getStorage.getValues.map(_ * -1)
    assertSameElement(_brzVector1, result)
  }
  ...
  test("canDot") {
    ...
    val localDot = _localVector2.getStorage.getValues.indices.map(i => _localVector2.get(i) * _localVector3.get(i)).sum
  ...
  test("canNorm") {
    ...
    val localNorm = math.sqrt(_localVector2.getStorage.getValues.map(x => x * x).sum)
  ...
  test("canNorm2") {
    ...
    val localNorm = _localVector2.getStorage.getValues.map(math.abs).sum
    assert(psNorm === localNorm)
  }
  ...
  test("math.max") {
    ...
    val max = (0 until dim).map(i => {
      if (_localVector2.get(i) > _localVector3.get(i)) _localVector2.get(i) else _localVector3.get(i)
    })
  ...
  test("math.pow") {
    ...
    val pow = _localVector2.getStorage.getValues.map(scala.math.pow(_, 2))
  ...
  test("math.exp") {
    ...
    val exp = _localVector2.getStorage.getValues.map(scala.math.exp)
  ...
  test("math.expm1") {
    ...
    val expm1 = _localVector2.getStorage.getValues.map(scala.math.expm1)
  ...
  test("math.log") {
    ...
    val log = _localVector2.getStorage.getValues.map(scala.math.log)
  ...
  test("math.log1p") {
    ...
    val log1p = _localVector2.getStorage.getValues.map(scala.math.log1p)
  ...
  test("math.log10") {
    ...
    val log10 = _localVector2.getStorage.getValues.map(scala.math.log10)
  ...
  test("math.ceil") {
    ...
    val ceil = _localVector2.getStorage.getValues.map(scala.math.ceil)
  ...
  test("math.floor") {
    ...
    val floor = _localVector2.getStorage.getValues.map(scala.math.floor)
  ...
  test("math.round") {
    ...
    val round = _localVector2.getStorage.getValues.map(scala.math.round)
  ...
  test("math.abs") {
    ...
    val abs = _localVector2.getStorage.getValues.map(scala.math.abs)
  ...
  test("math.signum") {
    ...
    val signum = _localVector2.getStorage.getValues.map(scala.math.signum)
  ...
  test("math.sqrtInto") {
    ...
    val sqrt = _localVector2.getStorage.getValues.map(scala.math.sqrt)
  ...
  test("blas.scale") {
    ...
    val localScale = _localVector2.getStorage.getValues.map(0.15 * _)
  ...
  test("blas.copy") {
    ...
    assertSameElement(dist, _localVector2.getStorage.getValues)
    dist.delete()
  }

  test("blas.nrm2") {
    val psNorm = blas.nrm2(_brzVector2)
    val localNorm = scala.math.sqrt(_localVector2.getStorage.getValues.map(x => x * x).sum)
    assert(psNorm === localNorm)
  }

  test("blas.asum") {
    val psSum = blas.asum(_brzVector2)
    val localSum = _localVector2.getStorage.getValues.map(scala.math.abs).sum
    assert(psSum === localSum)
  }

  test("blas.amax") {
    val psMax = blas.amax(_brzVector2)
    assert(psMax === _localVector2.getStorage.getValues.max)
  }

  test("blas.amin") {
    val psMin = blas.amin(_brzVector2)
    assert(psMin === _localVector2.getStorage.getValues.min)
  }
