...
public class LINESecondOrderModel extends EmbeddingModel {
  ...
  public LINESecondOrderModel(int dim, int negative, int seed, int maxIndex, int numNodeOneRow, float[][] layers) {
    super(dim, negative, seed, maxIndex, numNodeOneRow, -1, layers);
  }

  @Override
  public float[] dot(int batchSize, ByteBuf edges) {
  ...
  @Override
  public void adjust(ByteBuf dataBuf, int batchSize, int numInputs, int numOutputs) {
