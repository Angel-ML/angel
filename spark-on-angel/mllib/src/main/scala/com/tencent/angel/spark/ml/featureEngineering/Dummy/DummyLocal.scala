...
object DummyLocal {
  ...
  def main(args: Array[String]) {
    ...
    val mode = "local"
    //val input = "data/mlDataTest/Dummy_data_test.txt"
    val input = "data/mlDataTest/Iris.csv"
    val baseFeatIndexPath = null
    val featConfPath = "data/mlDataTest/dummy_config_SLR.txt"
    val partitionNum = 1
    val negSampleRate = 1
    val countThreshold = 0
    val output = "data/output/output"
    val instanceDir = null
    val indexDir = null
    val countDir = null
    val sep = ","
