...
object CommonFriendsV6Example {

  def main(args: Array[String]): Unit = {
    val mode = "local"
    val input = "../data/bc/edge"
    val secondInput = "../data/bc/edge"
    ...
    val commonfriends = new CommonFriendsV6()
      ...
      .setInput(input)
      .setExtraInputs(Array(secondInput))
      .setIsCompressed(isCompressed)
      .setSrcNodeIndex(srcIndex)
      .setDstNodeIndex(dstIndex)

    val df = GraphIO.load(input, isWeighted = isCompressed, sep = sep)
