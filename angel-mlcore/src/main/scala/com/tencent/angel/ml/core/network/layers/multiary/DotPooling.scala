...
import com.tencent.angel.ml.servingmath2.matrix.{BlasDoubleMatrix, BlasFloatMatrix, Matrix}
import com.tencent.angel.ml.servingmath2.storage.{IntDoubleDenseVectorStorage, IntFloatDenseVectorStorage}
