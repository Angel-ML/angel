...
public class SVMLocalExample {


  private static final Log LOG = LogFactory.getLog(SVMLocalExample.class);
  ...
  public void setConf(int mode) {
    ...
    // Dataset
    String trainInput = "../data/w6a/w6a_300d_train.libsvm";
    String predictInput = "../data/w6a/w6a_300d_test.libsvm";
    ...
    if (mode == 1) {  // train mode
      ...
      conf.set(AngelConf.ANGEL_SAVE_MODEL_PATH, LOCAL_FS + TMP_PATH + "/model/SVM");
  ...
  public void train() {
    ...
    try {
      ...
      LOG.error("run SVMLocalExample:train failed.", e);
      throw e;
    }
  ...
  public void incTrain() {
    ...
    try {
      ...
      LOG.error("run SVMLocalExample:incTrain failed.", e);
      throw e;
    }
  ...
  public void predict() {
    ...
    try {
      ...
      LOG.error("run SVMLocalExample:predict failed.", e);
      throw e;
    }
  }

  public static void main(String[] args) throws Exception {
    SVMLocalExample example = new SVMLocalExample();
