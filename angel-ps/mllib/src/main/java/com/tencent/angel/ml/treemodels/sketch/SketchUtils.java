...
public final class SketchUtils {
    ...
    public static void compactBuffer(final float[] srcBuf, int srcOffset,
    ...
    public static void mergeArrays(final float[] src1, int srcOffset1,
    ...
    public static void levelwisePropagation(long bitPattern, int k,
    ...
    public static void blockyMergeSort(final float[] keys, final long[] values,
    ...
    public static void blockyMerge(final float []kSrc, final long []vSrc,
