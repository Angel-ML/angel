...
public class CompressUpdateParam extends UpdateParam {
  ...
  @Override public List<PartitionUpdateParam> split() {
    ...
    for (PartitionKey part : partList) {
      ...
      partParams.add(
        new CompressPartitionUpdateParam(matrixId, part, rowId, (int) part.getStartCol(),
          (int) part.getEndCol(), array, bitsPerItem));
    }
  ...
  public static class CompressPartitionUpdateParam extends PartitionUpdateParam {
    ...
    public CompressPartitionUpdateParam(int matrixId, PartitionKey partKey, int rowId, int start,
      int end, double[] array, int bitPerItem) {
    ...
    @Override public String toString() {
      return "CompressPartitionUpdateParam [rowId=" + rowId + ", bitPerItem=" + bitPerItem
  ...
  public static void main(String[] argv) {
    ...
    byte[] tmp = CompressUpdateParam.CompressPartitionUpdateParam
