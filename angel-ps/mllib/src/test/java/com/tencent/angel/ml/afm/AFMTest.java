...
package com.tencent.angel.ml.afm;
...
public class AFMTest {
  ...
  private static final Log LOG = LogFactory.getLog(AFMTest.class);
  ...
  private void setSystemConf() throws Exception {
    try {
      ...
      String angelConfFile = "./src/test/jsons/afm.json";
      conf.set(AngelConf.ANGEL_ML_CONF, angelConfFile);
      conf.set(AngelMLConf.ML_MODEL_CLASS_NAME(), CLASSBASE + "AFM");
    } catch (Exception x) {
  ...
  @Test public void testAFM() throws Exception {
    setSystemConf();
    trainTest();
    //predictTest();
  }
  ...
  private void trainTest() throws Exception {
    try {
      String inputPath = "../../data/census/census_148d_train.libsvm";
  ...
  private void predictTest() throws Exception {
    try {
      String inputPath = "../../data/census/census_148d_test.libsvm";
      String modelPath = LOCAL_FS + TMP_PATH + "/model/AFM";
