...
package com.tencent.angel.ml.pnn;
...
public class PNNTest {
  ...
  private void setSystemConf() throws Exception {
    try {
      ...
      String savePath = LOCAL_FS + TMP_PATH + "/model/PNN";
      String logPath = LOCAL_FS + TMP_PATH + "/PNNlog";
      // Set save model path
      ...
      conf.set(MLCoreConf.ML_MODEL_CLASS_NAME(), CLASSBASE + "ProductNeuralNetwork");
    } catch (Exception x) {
