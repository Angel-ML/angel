...
public class MRTaskContext implements TaskAttemptContext {
  ...
  @Override public Counter getCounter(Enum<?> arg0) {
    return null;
  }

  @Override public Counter getCounter(String arg0, String arg1) {
    return null;
  }
  ...
  @Override public void setStatus(String arg0) {
  ...
  @Override public boolean userClassesTakesPrecedence() {
    return true;
  }
