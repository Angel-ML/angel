...
/**
 * The operator for the storage that store <long, double> values
 */
public interface ILongDoubleOp extends ILongKeyOp, IDoubleValueOp {
   ...
   */
  void set(long[] indices, double[] values);
   ...
   */
  void addTo(long[] indices, double[] values);
   ...
   */
  void mergeTo(LongDoubleVector vector);
   ...
   * @return element value
   */
  double initAndGet(long index, InitFunc func);
}
