...
public class CompBinaryExecutor {
    ...
    private static void apply(CompIntDoubleVector v1, CompIntDoubleVector v2, Binary op, CompIntDoubleVector result, int start, int end) {
    ...
    private static void apply(CompIntDoubleVector v1, CompIntFloatVector v2, Binary op, CompIntDoubleVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            IntDoubleVector[] v1Parts = v1.getPartitions();
    ...
    private static void apply(CompIntDoubleVector v1, CompIntLongVector v2, Binary op, CompIntDoubleVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            IntDoubleVector[] v1Parts = v1.getPartitions();
    ...
    private static void apply(CompIntDoubleVector v1, CompIntIntVector v2, Binary op, CompIntDoubleVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            IntDoubleVector[] v1Parts = v1.getPartitions();
    ...
    private static void apply(CompIntFloatVector v1, CompIntFloatVector v2, Binary op, CompIntFloatVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
    ...
    private static void apply(CompIntFloatVector v1, CompIntLongVector v2, Binary op, CompIntFloatVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            IntFloatVector[] v1Parts = v1.getPartitions();
            IntLongVector[] v2Parts = v2.getPartitions();
            if (op.isInplace()) {
    ...
    private static void apply(CompIntFloatVector v1, CompIntIntVector v2, Binary op, CompIntFloatVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            IntFloatVector[] v1Parts = v1.getPartitions();
            IntIntVector[] v2Parts = v2.getPartitions();
            if (op.isInplace()) {
    ...
    private static void apply(CompIntLongVector v1, CompIntLongVector v2, Binary op, CompIntLongVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
    ...
    private static void apply(CompIntLongVector v1, CompIntIntVector v2, Binary op, CompIntLongVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            IntLongVector[] v1Parts = v1.getPartitions();
            IntIntVector[] v2Parts = v2.getPartitions();
            if (op.isInplace()) {
    ...
    private static void apply(CompIntIntVector v1, CompIntIntVector v2, Binary op, CompIntIntVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
    ...
    private static void apply(CompLongDoubleVector v1, CompLongDoubleVector v2, Binary op, CompLongDoubleVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
    ...
    private static void apply(CompLongDoubleVector v1, CompLongFloatVector v2, Binary op, CompLongDoubleVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            LongDoubleVector[] v1Parts = v1.getPartitions();
    ...
    private static void apply(CompLongDoubleVector v1, CompLongLongVector v2, Binary op, CompLongDoubleVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            LongDoubleVector[] v1Parts = v1.getPartitions();
    ...
    private static void apply(CompLongDoubleVector v1, CompLongIntVector v2, Binary op, CompLongDoubleVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            LongDoubleVector[] v1Parts = v1.getPartitions();
    ...
    private static void apply(CompLongFloatVector v1, CompLongFloatVector v2, Binary op, CompLongFloatVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
    ...
    private static void apply(CompLongFloatVector v1, CompLongLongVector v2, Binary op, CompLongFloatVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            LongFloatVector[] v1Parts = v1.getPartitions();
            LongLongVector[] v2Parts = v2.getPartitions();
            if (op.isInplace()) {
    ...
    private static void apply(CompLongFloatVector v1, CompLongIntVector v2, Binary op, CompLongFloatVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            LongFloatVector[] v1Parts = v1.getPartitions();
            LongIntVector[] v2Parts = v2.getPartitions();
            if (op.isInplace()) {
    ...
    private static void apply(CompLongLongVector v1, CompLongLongVector v2, Binary op, CompLongLongVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
    ...
    private static void apply(CompLongLongVector v1, CompLongIntVector v2, Binary op, CompLongLongVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
            LongLongVector[] v1Parts = v1.getPartitions();
            LongIntVector[] v2Parts = v2.getPartitions();
            if (op.isInplace()) {
    ...
    private static void apply(CompLongIntVector v1, CompLongIntVector v2, Binary op, CompLongIntVector result, int start, int end) {
        if (v1.isCompatable(v2)) {
