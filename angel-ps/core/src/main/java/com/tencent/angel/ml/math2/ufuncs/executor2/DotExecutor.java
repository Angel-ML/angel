...
import com.tencent.angel.ml.math2.ufuncs.executor2.comp.CompDotExecutor;
import com.tencent.angel.ml.math2.ufuncs.executor2.mixed.MixedDotExecutor;
import com.tencent.angel.ml.math2.ufuncs.executor2.simple.SimpleDotExecutor;
  ...
  public static double apply(Vector v1, Vector v2) {
	if (v1 instanceof ComponentVector && v2 instanceof ComponentVector) {
	  ...
	  if (v1 instanceof ComponentVector) {
		return MixedDotExecutor.apply(v1, v2);
	  } else {
		return MixedDotExecutor.apply(v2, v1);
	  }
	} else {
	  try {
