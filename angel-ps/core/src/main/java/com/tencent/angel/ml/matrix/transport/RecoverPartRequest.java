...
public class RecoverPartRequest extends PartitionRequest {
   ...
   */
  public RecoverPartRequest(Int2IntOpenHashMap taskIndexToClockMap, PartitionKey partKey, ServerPartition part) {
    super(0, partKey);
  ...
  public int bufferLen() {
    return super.bufferLen()
      + ((part != null) ? part.bufferLen() : 0)
      + 4 + ((taskIndexToClockMap != null) ? taskIndexToClockMap.size() * 8 : 0);
  }
  ...
  @Override public String toString() {
    return "RecoverPartRequest{" + "part=" + part + ", taskIndexToClockMap=" + toString(taskIndexToClockMap)
      + "} " + super.toString();
  }
