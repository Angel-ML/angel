...
public class PSClient {
  ...
  private void send(ParameterServerId serverId, Location location, int seqId, Request request,
    ByteBuf msg, FutureResult<Response> result) {
    if (location == null) {
   ...
   */
  public FutureResult<Response> recoverPart(ParameterServerId serverId, Location location,
   ...
   */
  public FutureResult<Response> put(ParameterServerId serverId, Location location, Request request,
    ByteBuf update) {
