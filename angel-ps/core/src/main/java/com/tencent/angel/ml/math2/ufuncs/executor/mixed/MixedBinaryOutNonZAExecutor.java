    ...
    if (v2.isDense()) {
      ...
      if (v2.isSparse()) {
        ...
        while (iter.hasNext()) {
          ...
          int pidx = (int) (gidx / subDim);
          int subidx = gidx % subDim;
          resParts[pidx].set(subidx, op.apply(resParts[pidx].get(subidx), entry.getDoubleValue()));
        }
      } else { // sorted
        int subDim = (v1.getDim() + v1.getNumPartitions() - 1) / v1.getNumPartitions();
    ...
    if (v2.isDense()) {
      ...
      if (v2.isSparse()) {
        ...
        while (iter.hasNext()) {
          ...
          int pidx = (int) (gidx / subDim);
          int subidx = gidx % subDim;
          resParts[pidx].set(subidx, op.apply(resParts[pidx].get(subidx), entry.getFloatValue()));
        }
      } else { // sorted
        int subDim = (v1.getDim() + v1.getNumPartitions() - 1) / v1.getNumPartitions();
        int[] v2Indices = v2.getStorage().getIndices();
    ...
    if (v2.isDense()) {
      ...
      if (v2.isSparse()) {
        ...
        while (iter.hasNext()) {
          ...
          int pidx = (int) (gidx / subDim);
          int subidx = gidx % subDim;
          resParts[pidx].set(subidx, op.apply(resParts[pidx].get(subidx), entry.getLongValue()));
        }
      } else { // sorted
        int subDim = (v1.getDim() + v1.getNumPartitions() - 1) / v1.getNumPartitions();
        int[] v2Indices = v2.getStorage().getIndices();
    ...
    if (v2.isDense()) {
      ...
      if (v2.isSparse()) {
        ...
        while (iter.hasNext()) {
          ...
          int pidx = (int) (gidx / subDim);
          int subidx = gidx % subDim;
          resParts[pidx].set(subidx, op.apply(resParts[pidx].get(subidx), entry.getIntValue()));
        }
      } else { // sorted
        int subDim = (v1.getDim() + v1.getNumPartitions() - 1) / v1.getNumPartitions();
        int[] v2Indices = v2.getStorage().getIndices();
