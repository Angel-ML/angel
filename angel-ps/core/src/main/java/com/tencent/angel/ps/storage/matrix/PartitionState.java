...
public enum PartitionState {
  INITIALIZING(0, PartitionState.INITIALIZE_VALUE), LOADING(1,
    PartitionState.LOADING_VALUE), RECOVERING(2, PartitionState.RECOVERING_VALUE), READ_ONLY(3,
    PartitionState.READ_ONLY_VALUE), READ_AND_WRITE(4, PartitionState.READ_AND_WRITE_VALUE), SAVING(
    5, PartitionState.SAVING_VALUE), INVALID(6, PartitionState.INVALID_VALUE);
