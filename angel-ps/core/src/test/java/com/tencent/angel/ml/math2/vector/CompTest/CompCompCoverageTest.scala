...
class CompCompCoverageTest {
  ...
  def compVScompAddTest() {
    (0 until list.size()).foreach { i =>
      (0 until list.size()).foreach { j =>
        try {
          println(s"${list.get(i).add(list.get(j)).sum()}")
        } catch {
    ...
    (0 until llist.size()).foreach { i =>
      (0 until llist.size()).foreach { j =>
        try {
          println(s"${llist.get(i).add(llist.get(j)).sum()}")
        } catch {
          case e: AngelException => {
            println(e)
          }
  ...
  def compVScompSubTest() {
    (0 until list.size()).foreach { i =>
      (0 until list.size()).foreach { j =>
        try {
          println(s"${list.get(i).mul(list.get(j)).sum()}")
        } catch {
          case e: AngelException => {
            println(e)
          }
  ...
  def compVScompDivTest() {
    (0 until list.size()).foreach { i =>
      (0 until list.size()).foreach { j =>
        try {
          println(s"${list.get(i).div(list.get(j)).sum()}")
        } catch {
          case e: AngelException => {
            println(e)
          }
  ...
  def compVScompAxpyTest() {
    (0 until list.size()).foreach { i =>
      (0 until list.size()).foreach { j =>
        try {
          println(s"${list.get(i).axpy(list.get(j), 2.0).sum()}")
        } catch {
          case e: AngelException => {
            println(e)
          }
  ...
  @Test
  def compVScompDotTest() {
    (0 until list.size()).foreach { i =>
      (0 until list.size()).foreach { j =>
        try {
          println(s"${list.get(i).dot(list.get(j))}")
        } catch {
          case e: AngelException => {
            println(e)
          }
  ...
  def compVScompIaddTest() {
    (0 until list.size()).foreach { i =>
      if (i < 8) {
        ...
        val list12 = Array(sorted11, sorted12, sparse11)
        val comp12 = new CompIntDoubleVector(dim * list12.length, list12)
        println(s"${comp1_1.iadd(list.get(i)).sum()},${comp1_1.sum()}")
        println(s"${comp1_2.iadd(list.get(i)).sum()},${comp1_2.sum()}")
        println(s"${comp1_3.iadd(list.get(i)).sum()},${comp1_3.sum()}")
        println(s"${comp1_4.iadd(list.get(i)).sum()},${comp1_4.sum()}")
        println(s"${comp1_5.iadd(list.get(i)).sum()},${comp1_5.sum()}")
        println(s"${comp1_6.iadd(list.get(i)).sum()},${comp1_6.sum()}")
        println(s"${comp11.iadd(list.get(i)).sum()},${comp11.sum()}")
        println(s"${comp12.iadd(list.get(i)).sum()},${comp12.sum()}")
      } else if (i < 16) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp2_1.iadd(list.get(i)).sum()},${comp2_1.sum()}")
        println(s"${comp2_2.iadd(list.get(i)).sum()},${comp2_2.sum()}")
        println(s"${comp2_3.iadd(list.get(i)).sum()},${comp2_3.sum()}")
        println(s"${comp2_4.iadd(list.get(i)).sum()},${comp2_4.sum()}")
        println(s"${comp2_5.iadd(list.get(i)).sum()},${comp2_5.sum()}")
        println(s"${comp2_6.iadd(list.get(i)).sum()},${comp2_6.sum()}")
        println(s"${comp21.iadd(list.get(i)).sum()},${comp21.sum()}")
        println(s"${comp22.iadd(list.get(i)).sum()},${comp22.sum()}")
      } else if (i < 24) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp3_1.iadd(list.get(i)).sum()},${comp3_1.sum()}")
        println(s"${comp3_2.iadd(list.get(i)).sum()},${comp3_2.sum()}")
        println(s"${comp3_3.iadd(list.get(i)).sum()},${comp3_3.sum()}")
        println(s"${comp3_4.iadd(list.get(i)).sum()},${comp3_4.sum()}")
        println(s"${comp3_5.iadd(list.get(i)).sum()},${comp3_5.sum()}")
        println(s"${comp3_6.iadd(list.get(i)).sum()},${comp3_6.sum()}")
        println(s"${comp31.iadd(list.get(i)).sum()},${comp31.sum()}")
        println(s"${comp32.iadd(list.get(i)).sum()},${comp32.sum()}")
      } else if (i < 32) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        val list42 = Array(sorted41, sorted42, sparse41)
        val comp42 = new CompIntIntVector(dim * list42.length, list42)
        println(s"${comp4_1.iadd(list.get(i)).sum()},${comp4_1.sum()}")
        println(s"${comp4_2.iadd(list.get(i)).sum()},${comp4_2.sum()}")
        println(s"${comp4_3.iadd(list.get(i)).sum()},${comp4_3.sum()}")
        println(s"${comp4_4.iadd(list.get(i)).sum()},${comp4_4.sum()}")
        println(s"${comp4_5.iadd(list.get(i)).sum()},${comp4_5.sum()}")
        println(s"${comp4_6.iadd(list.get(i)).sum()},${comp4_6.sum()}")
        println(s"${comp41.iadd(list.get(i)).sum()},${comp41.sum()}")
        println(s"${comp42.iadd(list.get(i)).sum()},${comp42.sum()}")
      }
    }
    //longkey
    (0 until llist.size()).foreach { i =>
      if (i < 4) {
        ...
        val lcomp11 = new CompLongDoubleVector(dim * llist11.length, llist11)
        val lcomp12 = new CompLongDoubleVector(dim * llist12.length, llist12)
        println(s"${lcomp1_1.iadd(llist.get(i)).sum()}, ${lcomp1_1.sum()}")
        println(s"${lcomp1_2.iadd(llist.get(i)).sum()}, ${lcomp1_2.sum()}")
        println(s"${lcomp11.iadd(llist.get(i)).sum()}, ${lcomp11.sum()}")
        println(s"${lcomp12.iadd(llist.get(i)).sum()}, ${lcomp12.sum()}")
      } else if (i < 8) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp21 = new CompLongFloatVector(dim * llist21.length, llist21)
        val lcomp22 = new CompLongFloatVector(dim * llist22.length, llist22)
        println(s"${lcomp2_1.iadd(llist.get(i)).sum()}, ${lcomp2_1.sum()}")
        println(s"${lcomp2_2.iadd(llist.get(i)).sum()}, ${lcomp2_2.sum()}")
        println(s"${lcomp21.iadd(llist.get(i)).sum()}, ${lcomp21.sum()}")
        println(s"${lcomp22.iadd(llist.get(i)).sum()}, ${lcomp22.sum()}")
      } else if (i < 12) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp31 = new CompLongLongVector(dim * llist31.length, llist31)
        val lcomp32 = new CompLongLongVector(dim * llist32.length, llist32)
        println(s"${lcomp3_1.iadd(llist.get(i)).sum()}, ${lcomp3_1.sum()}")
        println(s"${lcomp3_2.iadd(llist.get(i)).sum()}, ${lcomp3_2.sum()}")
        println(s"${lcomp31.iadd(llist.get(i)).sum()}, ${lcomp31.sum()}")
        println(s"${lcomp32.iadd(llist.get(i)).sum()}, ${lcomp32.sum()}")
        ...
        val lcomp41 = new CompLongIntVector(dim * llist41.length, llist41)
        val lcomp42 = new CompLongIntVector(dim * llist42.length, llist42)
        println(s"${lcomp4_1.iadd(llist.get(i)).sum()}, ${lcomp4_1.sum()}")
        println(s"${lcomp4_2.iadd(llist.get(i)).sum()}, ${lcomp4_2.sum()}")
        println(s"${lcomp41.iadd(llist.get(i)).sum()}, ${lcomp41.sum()}")
        println(s"${lcomp42.iadd(llist.get(i)).sum()}, ${lcomp42.sum()}")
      }
    }
  }
  ...
  def compVScompIsubTest() {
    (0 until list.size()).foreach { i =>
      if (i < 8) {
        ...
        val list12 = Array(sorted11, sorted12, sparse11)
        val comp12 = new CompIntDoubleVector(dim * list12.length, list12)
        println(s"${comp1_1.isub(list.get(i)).sum()},${comp1_1.sum()}")
        println(s"${comp1_2.isub(list.get(i)).sum()},${comp1_2.sum()}")
        println(s"${comp1_3.isub(list.get(i)).sum()},${comp1_3.sum()}")
        println(s"${comp1_4.isub(list.get(i)).sum()},${comp1_4.sum()}")
        println(s"${comp1_5.isub(list.get(i)).sum()},${comp1_5.sum()}")
        println(s"${comp1_6.isub(list.get(i)).sum()},${comp1_6.sum()}")
        println(s"${comp11.isub(list.get(i)).sum()},${comp11.sum()}")
        println(s"${comp12.isub(list.get(i)).sum()},${comp12.sum()}")
      } else if (i < 16) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp2_1.isub(list.get(i)).sum()},${comp2_1.sum()}")
        println(s"${comp2_2.isub(list.get(i)).sum()},${comp2_2.sum()}")
        println(s"${comp2_3.isub(list.get(i)).sum()},${comp2_3.sum()}")
        println(s"${comp2_4.isub(list.get(i)).sum()},${comp2_4.sum()}")
        println(s"${comp2_5.isub(list.get(i)).sum()},${comp2_5.sum()}")
        println(s"${comp2_6.isub(list.get(i)).sum()},${comp2_6.sum()}")
        println(s"${comp21.isub(list.get(i)).sum()},${comp21.sum()}")
        println(s"${comp22.isub(list.get(i)).sum()},${comp22.sum()}")
      } else if (i < 24) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp3_1.isub(list.get(i)).sum()},${comp3_1.sum()}")
        println(s"${comp3_2.isub(list.get(i)).sum()},${comp3_2.sum()}")
        println(s"${comp3_3.isub(list.get(i)).sum()},${comp3_3.sum()}")
        println(s"${comp3_4.isub(list.get(i)).sum()},${comp3_4.sum()}")
        println(s"${comp3_5.isub(list.get(i)).sum()},${comp3_5.sum()}")
        println(s"${comp3_6.isub(list.get(i)).sum()},${comp3_6.sum()}")
        println(s"${comp31.isub(list.get(i)).sum()},${comp31.sum()}")
        println(s"${comp32.isub(list.get(i)).sum()},${comp32.sum()}")
      } else if (i < 32) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        val list42 = Array(sorted41, sorted42, sparse41)
        val comp42 = new CompIntIntVector(dim * list42.length, list42)
        println(s"${comp4_1.isub(list.get(i)).sum()},${comp4_1.sum()}")
        println(s"${comp4_2.isub(list.get(i)).sum()},${comp4_2.sum()}")
        println(s"${comp4_3.isub(list.get(i)).sum()},${comp4_3.sum()}")
        println(s"${comp4_4.isub(list.get(i)).sum()},${comp4_4.sum()}")
        println(s"${comp4_5.isub(list.get(i)).sum()},${comp4_5.sum()}")
        println(s"${comp4_6.isub(list.get(i)).sum()},${comp4_6.sum()}")
        println(s"${comp41.isub(list.get(i)).sum()},${comp41.sum()}")
        println(s"${comp42.isub(list.get(i)).sum()},${comp42.sum()}")
      }
    }
    //longkey
    (0 until llist.size()).foreach { i =>
      if (i < 4) {
        ...
        val lcomp11 = new CompLongDoubleVector(dim * llist11.length, llist11)
        val lcomp12 = new CompLongDoubleVector(dim * llist12.length, llist12)
        println(s"${lcomp1_1.isub(llist.get(i)).sum()}, ${lcomp1_1.sum()}")
        println(s"${lcomp1_2.isub(llist.get(i)).sum()}, ${lcomp1_2.sum()}")
        println(s"${lcomp11.isub(llist.get(i)).sum()}, ${lcomp11.sum()}")
        println(s"${lcomp12.isub(llist.get(i)).sum()}, ${lcomp12.sum()}")
      } else if (i < 8) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp21 = new CompLongFloatVector(dim * llist21.length, llist21)
        val lcomp22 = new CompLongFloatVector(dim * llist22.length, llist22)
        println(s"${lcomp2_1.isub(llist.get(i)).sum()}, ${lcomp2_1.sum()}")
        println(s"${lcomp2_2.isub(llist.get(i)).sum()}, ${lcomp2_2.sum()}")
        println(s"${lcomp21.isub(llist.get(i)).sum()}, ${lcomp21.sum()}")
        println(s"${lcomp22.isub(llist.get(i)).sum()}, ${lcomp22.sum()}")
      } else if (i < 12) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp31 = new CompLongLongVector(dim * llist31.length, llist31)
        val lcomp32 = new CompLongLongVector(dim * llist32.length, llist32)
        println(s"${lcomp3_1.isub(llist.get(i)).sum()}, ${lcomp3_1.sum()}")
        println(s"${lcomp3_2.isub(llist.get(i)).sum()}, ${lcomp3_2.sum()}")
        println(s"${lcomp31.isub(llist.get(i)).sum()}, ${lcomp31.sum()}")
        println(s"${lcomp32.isub(llist.get(i)).sum()}, ${lcomp32.sum()}")
        ...
        val lcomp41 = new CompLongIntVector(dim * llist41.length, llist41)
        val lcomp42 = new CompLongIntVector(dim * llist42.length, llist42)
        println(s"${lcomp4_1.isub(llist.get(i)).sum()}, ${lcomp4_1.sum()}")
        println(s"${lcomp4_2.isub(llist.get(i)).sum()}, ${lcomp4_2.sum()}")
        println(s"${lcomp41.isub(llist.get(i)).sum()}, ${lcomp41.sum()}")
        println(s"${lcomp42.isub(llist.get(i)).sum()}, ${lcomp42.sum()}")
      }
    }
  }
  ...
  def compVScompImulTest() {
    (0 until list.size()).foreach { i =>
      if (i < 8) {
        ...
        val list12 = Array(sorted11, sorted12, sparse11)
        val comp12 = new CompIntDoubleVector(dim * list12.length, list12)
        println(s"${comp1_1.imul(list.get(i)).sum()},${comp1_1.sum()}")
        println(s"${comp1_2.imul(list.get(i)).sum()},${comp1_2.sum()}")
        println(s"${comp1_3.imul(list.get(i)).sum()},${comp1_3.sum()}")
        println(s"${comp1_4.imul(list.get(i)).sum()},${comp1_4.sum()}")
        println(s"${comp1_5.imul(list.get(i)).sum()},${comp1_5.sum()}")
        println(s"${comp1_6.imul(list.get(i)).sum()},${comp1_6.sum()}")
        println(s"${comp11.imul(list.get(i)).sum()},${comp11.sum()}")
        println(s"${comp12.imul(list.get(i)).sum()},${comp12.sum()}")
      } else if (i < 16) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp2_1.imul(list.get(i)).sum()},${comp2_1.sum()}")
        println(s"${comp2_2.imul(list.get(i)).sum()},${comp2_2.sum()}")
        println(s"${comp2_3.imul(list.get(i)).sum()},${comp2_3.sum()}")
        println(s"${comp2_4.imul(list.get(i)).sum()},${comp2_4.sum()}")
        println(s"${comp2_5.imul(list.get(i)).sum()},${comp2_5.sum()}")
        println(s"${comp2_6.imul(list.get(i)).sum()},${comp2_6.sum()}")
        println(s"${comp21.imul(list.get(i)).sum()},${comp21.sum()}")
        println(s"${comp22.imul(list.get(i)).sum()},${comp22.sum()}")
      } else if (i < 24) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp3_1.imul(list.get(i)).sum()},${comp3_1.sum()}")
        println(s"${comp3_2.imul(list.get(i)).sum()},${comp3_2.sum()}")
        println(s"${comp3_3.imul(list.get(i)).sum()},${comp3_3.sum()}")
        println(s"${comp3_4.imul(list.get(i)).sum()},${comp3_4.sum()}")
        println(s"${comp3_5.imul(list.get(i)).sum()},${comp3_5.sum()}")
        println(s"${comp3_6.imul(list.get(i)).sum()},${comp3_6.sum()}")
        println(s"${comp31.imul(list.get(i)).sum()},${comp31.sum()}")
        println(s"${comp32.imul(list.get(i)).sum()},${comp32.sum()}")
      } else if (i < 32) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        val list42 = Array(sorted41, sorted42, sparse41)
        val comp42 = new CompIntIntVector(dim * list42.length, list42)
        println(s"${comp4_1.imul(list.get(i)).sum()},${comp4_1.sum()}")
        println(s"${comp4_2.imul(list.get(i)).sum()},${comp4_2.sum()}")
        println(s"${comp4_3.imul(list.get(i)).sum()},${comp4_3.sum()}")
        println(s"${comp4_4.imul(list.get(i)).sum()},${comp4_4.sum()}")
        println(s"${comp4_5.imul(list.get(i)).sum()},${comp4_5.sum()}")
        println(s"${comp4_6.imul(list.get(i)).sum()},${comp4_6.sum()}")
        println(s"${comp41.imul(list.get(i)).sum()},${comp41.sum()}")
        println(s"${comp42.imul(list.get(i)).sum()},${comp42.sum()}")
      }
    }
    //longkey
    (0 until llist.size()).foreach { i =>
      if (i < 4) {
        ...
        val lcomp11 = new CompLongDoubleVector(dim * llist11.length, llist11)
        val lcomp12 = new CompLongDoubleVector(dim * llist12.length, llist12)
        println(s"${lcomp1_1.imul(llist.get(i)).sum()}, ${lcomp1_1.sum()}")
        println(s"${lcomp1_2.imul(llist.get(i)).sum()}, ${lcomp1_2.sum()}")
        println(s"${lcomp11.imul(llist.get(i)).sum()}, ${lcomp11.sum()}")
        println(s"${lcomp12.imul(llist.get(i)).sum()}, ${lcomp12.sum()}")
      } else if (i < 8) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp21 = new CompLongFloatVector(dim * llist21.length, llist21)
        val lcomp22 = new CompLongFloatVector(dim * llist22.length, llist22)
        println(s"${lcomp2_1.imul(llist.get(i)).sum()}, ${lcomp2_1.sum()}")
        println(s"${lcomp2_2.imul(llist.get(i)).sum()}, ${lcomp2_2.sum()}")
        println(s"${lcomp21.imul(llist.get(i)).sum()}, ${lcomp21.sum()}")
        println(s"${lcomp22.imul(llist.get(i)).sum()}, ${lcomp22.sum()}")
      } else if (i < 12) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp31 = new CompLongLongVector(dim * llist31.length, llist31)
        val lcomp32 = new CompLongLongVector(dim * llist32.length, llist32)
        println(s"${lcomp3_1.imul(llist.get(i)).sum()}, ${lcomp3_1.sum()}")
        println(s"${lcomp3_2.imul(llist.get(i)).sum()}, ${lcomp3_2.sum()}")
        println(s"${lcomp31.imul(llist.get(i)).sum()}, ${lcomp31.sum()}")
        println(s"${lcomp32.imul(llist.get(i)).sum()}, ${lcomp32.sum()}")
        ...
        val lcomp41 = new CompLongIntVector(dim * llist41.length, llist41)
        val lcomp42 = new CompLongIntVector(dim * llist42.length, llist42)
        println(s"${lcomp4_1.imul(llist.get(i)).sum()}, ${lcomp4_1.sum()}")
        println(s"${lcomp4_2.imul(llist.get(i)).sum()}, ${lcomp4_2.sum()}")
        println(s"${lcomp41.imul(llist.get(i)).sum()}, ${lcomp41.sum()}")
        println(s"${lcomp42.imul(llist.get(i)).sum()}, ${lcomp42.sum()}")
      }
    }
  }
  ...
  def compVScompIdivTest() {
    (0 until list.size()).foreach { i =>
      if (i < 8) {
        ...
        val list12 = Array(sorted11, sorted12, sparse11)
        val comp12 = new CompIntDoubleVector(dim * list12.length, list12)
        println(s"${comp1_1.idiv(list.get(i)).sum()},${comp1_1.sum()}")
        println(s"${comp1_2.idiv(list.get(i)).sum()},${comp1_2.sum()}")
        println(s"${comp1_3.idiv(list.get(i)).sum()},${comp1_3.sum()}")
        println(s"${comp1_4.idiv(list.get(i)).sum()},${comp1_4.sum()}")
        println(s"${comp1_5.idiv(list.get(i)).sum()},${comp1_5.sum()}")
        println(s"${comp1_6.idiv(list.get(i)).sum()},${comp1_6.sum()}")
        println(s"${comp11.idiv(list.get(i)).sum()},${comp11.sum()}")
        println(s"${comp12.idiv(list.get(i)).sum()},${comp12.sum()}")
      } else if (i < 16) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp2_1.idiv(list.get(i)).sum()},${comp2_1.sum()}")
        println(s"${comp2_2.idiv(list.get(i)).sum()},${comp2_2.sum()}")
        println(s"${comp2_3.idiv(list.get(i)).sum()},${comp2_3.sum()}")
        println(s"${comp2_4.idiv(list.get(i)).sum()},${comp2_4.sum()}")
        println(s"${comp2_5.idiv(list.get(i)).sum()},${comp2_5.sum()}")
        println(s"${comp2_6.idiv(list.get(i)).sum()},${comp2_6.sum()}")
        println(s"${comp21.idiv(list.get(i)).sum()},${comp21.sum()}")
        println(s"${comp22.idiv(list.get(i)).sum()},${comp22.sum()}")
      } else if (i < 24) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp3_1.idiv(list.get(i)).sum()},${comp3_1.sum()}")
        println(s"${comp3_2.idiv(list.get(i)).sum()},${comp3_2.sum()}")
        println(s"${comp3_3.idiv(list.get(i)).sum()},${comp3_3.sum()}")
        println(s"${comp3_4.idiv(list.get(i)).sum()},${comp3_4.sum()}")
        println(s"${comp3_5.idiv(list.get(i)).sum()},${comp3_5.sum()}")
        println(s"${comp3_6.idiv(list.get(i)).sum()},${comp3_6.sum()}")
        println(s"${comp31.idiv(list.get(i)).sum()},${comp31.sum()}")
        println(s"${comp32.idiv(list.get(i)).sum()},${comp32.sum()}")
      } else if (i < 32) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        val list42 = Array(sorted41, sorted42, sparse41)
        val comp42 = new CompIntIntVector(dim * list42.length, list42)
        println(s"${comp4_1.idiv(list.get(i)).sum()},${comp4_1.sum()}")
        println(s"${comp4_2.idiv(list.get(i)).sum()},${comp4_2.sum()}")
        println(s"${comp4_3.idiv(list.get(i)).sum()},${comp4_3.sum()}")
        println(s"${comp4_4.idiv(list.get(i)).sum()},${comp4_4.sum()}")
        println(s"${comp4_5.idiv(list.get(i)).sum()},${comp4_5.sum()}")
        println(s"${comp4_6.idiv(list.get(i)).sum()},${comp4_6.sum()}")
        println(s"${comp41.idiv(list.get(i)).sum()},${comp41.sum()}")
        println(s"${comp42.idiv(list.get(i)).sum()},${comp42.sum()}")
      }
    }
    //longkey
    (0 until llist.size()).foreach { i =>
      if (i < 4) {
        ...
        val lcomp11 = new CompLongDoubleVector(dim * llist11.length, llist11)
        val lcomp12 = new CompLongDoubleVector(dim * llist12.length, llist12)
        println(s"${lcomp1_1.idiv(llist.get(i)).sum()}, ${lcomp1_1.sum()}")
        println(s"${lcomp1_2.idiv(llist.get(i)).sum()}, ${lcomp1_2.sum()}")
        println(s"${lcomp11.idiv(llist.get(i)).sum()}, ${lcomp11.sum()}")
        println(s"${lcomp12.idiv(llist.get(i)).sum()}, ${lcomp12.sum()}")
      } else if (i < 8) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp21 = new CompLongFloatVector(dim * llist21.length, llist21)
        val lcomp22 = new CompLongFloatVector(dim * llist22.length, llist22)
        println(s"${lcomp2_1.idiv(llist.get(i)).sum()}, ${lcomp2_1.sum()}")
        println(s"${lcomp2_2.idiv(llist.get(i)).sum()}, ${lcomp2_2.sum()}")
        println(s"${lcomp21.idiv(llist.get(i)).sum()}, ${lcomp21.sum()}")
        println(s"${lcomp22.idiv(llist.get(i)).sum()}, ${lcomp22.sum()}")
      } else if (i < 12) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp31 = new CompLongLongVector(dim * llist31.length, llist31)
        val lcomp32 = new CompLongLongVector(dim * llist32.length, llist32)
        println(s"${lcomp3_1.idiv(llist.get(i)).sum()}, ${lcomp3_1.sum()}")
        println(s"${lcomp3_2.idiv(llist.get(i)).sum()}, ${lcomp3_2.sum()}")
        println(s"${lcomp31.idiv(llist.get(i)).sum()}, ${lcomp31.sum()}")
        println(s"${lcomp32.idiv(llist.get(i)).sum()}, ${lcomp32.sum()}")
        ...
        val lcomp41 = new CompLongIntVector(dim * llist41.length, llist41)
        val lcomp42 = new CompLongIntVector(dim * llist42.length, llist42)
        println(s"${lcomp4_1.idiv(llist.get(i)).sum()}, ${lcomp4_1.sum()}")
        println(s"${lcomp4_2.idiv(llist.get(i)).sum()}, ${lcomp4_2.sum()}")
        println(s"${lcomp41.idiv(llist.get(i)).sum()}, ${lcomp41.sum()}")
        println(s"${lcomp42.idiv(llist.get(i)).sum()}, ${lcomp42.sum()}")
      }
    }
  }
  ...
  def compVScompIaxpyTest() {
    (0 until list.size()).foreach { i =>
      if (i < 8) {
        ...
        val list12 = Array(sorted11, sorted12, sparse11)
        val comp12 = new CompIntDoubleVector(dim * list12.length, list12)
        println(s"${comp1_1.iaxpy(list.get(i), 2.0).sum()},${comp1_1.sum()}")
        println(s"${comp1_2.iaxpy(list.get(i), 2.0).sum()},${comp1_2.sum()}")
        println(s"${comp1_3.iaxpy(list.get(i), 2.0).sum()},${comp1_3.sum()}")
        println(s"${comp1_4.iaxpy(list.get(i), 2.0).sum()},${comp1_4.sum()}")
        println(s"${comp1_5.iaxpy(list.get(i), 2.0).sum()},${comp1_5.sum()}")
        println(s"${comp1_6.iaxpy(list.get(i), 2.0).sum()},${comp1_6.sum()}")
        println(s"${comp11.iaxpy(list.get(i), 2.0).sum()},${comp11.sum()}")
        println(s"${comp12.iaxpy(list.get(i), 2.0).sum()},${comp12.sum()}")
      } else if (i < 16) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp2_1.iaxpy(list.get(i), 2.0).sum()},${comp2_1.sum()}")
        println(s"${comp2_2.iaxpy(list.get(i), 2.0).sum()},${comp2_2.sum()}")
        println(s"${comp2_3.iaxpy(list.get(i), 2.0).sum()},${comp2_3.sum()}")
        println(s"${comp2_4.iaxpy(list.get(i), 2.0).sum()},${comp2_4.sum()}")
        println(s"${comp2_5.iaxpy(list.get(i), 2.0).sum()},${comp2_5.sum()}")
        println(s"${comp2_6.iaxpy(list.get(i), 2.0).sum()},${comp2_6.sum()}")
        println(s"${comp21.iaxpy(list.get(i), 2.0).sum()},${comp21.sum()}")
        println(s"${comp22.iaxpy(list.get(i), 2.0).sum()},${comp22.sum()}")
      } else if (i < 24) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        println(s"${comp3_1.iaxpy(list.get(i), 2.0).sum()},${comp3_1.sum()}")
        println(s"${comp3_2.iaxpy(list.get(i), 2.0).sum()},${comp3_2.sum()}")
        println(s"${comp3_3.iaxpy(list.get(i), 2.0).sum()},${comp3_3.sum()}")
        println(s"${comp3_4.iaxpy(list.get(i), 2.0).sum()},${comp3_4.sum()}")
        println(s"${comp3_5.iaxpy(list.get(i), 2.0).sum()},${comp3_5.sum()}")
        println(s"${comp3_6.iaxpy(list.get(i), 2.0).sum()},${comp3_6.sum()}")
        println(s"${comp31.iaxpy(list.get(i), 2.0).sum()},${comp31.sum()}")
        println(s"${comp32.iaxpy(list.get(i), 2.0).sum()},${comp32.sum()}")
      } else if (i < 32) {
        val dense1 = VFactory.denseDoubleVector(densedoubleValues)
        val sparse1 = VFactory.sparseDoubleVector(dim, intrandIndices, doubleValues)
        val sorted1 = VFactory.sortedDoubleVector(dim, intsortedIndices, doubleValues)
        ...
        val list42 = Array(sorted41, sorted42, sparse41)
        val comp42 = new CompIntIntVector(dim * list42.length, list42)
        println(s"${comp4_1.iaxpy(list.get(i), 2.0).sum()},${comp4_1.sum()}")
        println(s"${comp4_2.iaxpy(list.get(i), 2.0).sum()},${comp4_2.sum()}")
        println(s"${comp4_3.iaxpy(list.get(i), 2.0).sum()},${comp4_3.sum()}")
        println(s"${comp4_4.iaxpy(list.get(i), 2.0).sum()},${comp4_4.sum()}")
        println(s"${comp4_5.iaxpy(list.get(i), 2.0).sum()},${comp4_5.sum()}")
        println(s"${comp4_6.iaxpy(list.get(i), 2.0).sum()},${comp4_6.sum()}")
        println(s"${comp41.iaxpy(list.get(i), 2.0).sum()},${comp41.sum()}")
        println(s"${comp42.iaxpy(list.get(i), 2.0).sum()},${comp42.sum()}")
      }
    }
    //longkey
    (0 until llist.size()).foreach { i =>
      if (i < 4) {
        ...
        val lcomp11 = new CompLongDoubleVector(dim * llist11.length, llist11)
        val lcomp12 = new CompLongDoubleVector(dim * llist12.length, llist12)
        println(s"${lcomp1_1.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp1_1.sum()}")
        println(s"${lcomp1_2.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp1_2.sum()}")
        println(s"${lcomp11.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp11.sum()}")
        println(s"${lcomp12.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp12.sum()}")
      } else if (i < 8) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp21 = new CompLongFloatVector(dim * llist21.length, llist21)
        val lcomp22 = new CompLongFloatVector(dim * llist22.length, llist22)
        println(s"${lcomp2_1.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp2_1.sum()}")
        println(s"${lcomp2_2.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp2_2.sum()}")
        println(s"${lcomp21.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp21.sum()}")
        println(s"${lcomp22.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp22.sum()}")
      } else if (i < 12) {
        val lsparse1 = VFactory.sparseLongKeyDoubleVector(dim, longrandIndices, doubleValues)
        val lsorted1 = VFactory.sortedLongKeyDoubleVector(dim, longsortedIndices, doubleValues)
        val llist1_1 = Array(lsparse1, lsorted1)
        ...
        val lcomp31 = new CompLongLongVector(dim * llist31.length, llist31)
        val lcomp32 = new CompLongLongVector(dim * llist32.length, llist32)
        println(s"${lcomp3_1.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp3_1.sum()}")
        println(s"${lcomp3_2.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp3_2.sum()}")
        println(s"${lcomp31.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp31.sum()}")
        println(s"${lcomp32.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp32.sum()}")
        ...
        val lcomp41 = new CompLongIntVector(dim * llist41.length, llist41)
        val lcomp42 = new CompLongIntVector(dim * llist42.length, llist42)
        println(s"${lcomp4_1.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp4_1.sum()}")
        println(s"${lcomp4_2.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp4_2.sum()}")
        println(s"${lcomp41.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp41.sum()}")
        println(s"${lcomp42.iaxpy(llist.get(i), 2.0).sum()}, ${lcomp42.sum()}")
      }
    }
  }
}
