...
public class LoadTest2 {
  ...
  public void setup() throws Exception {
    ...
    conf.set(AngelConf.ANGEL_SAVE_MODEL_PATH, "file:///F:\\test\\model_2");
    //conf.set(AngelConf.ANGEL_LOAD_MODEL_PATH, "file:///F:\\test\\model_1");
    ...
    ModelLoadContext loadContext = new ModelLoadContext("file:///F:\\test\\model_1");
    loadContext.addMatrix(new MatrixLoadContext(SPARSE_FLOAT_MAT));
