...
package com.tencent.angel.graph.client.psf.init.initedgetypes;

import com.tencent.angel.graph.client.psf.init.GeneralInitParam;
import com.tencent.angel.graph.data.EdgeType;
...
public class InitEdgeTypes extends UpdateFunc {

  /**
   * Create a new UpdateParam
   */
  public InitEdgeTypes(GeneralInitParam param) {
    super(param);
  }

  public InitEdgeTypes() {
    this(null);
  }
