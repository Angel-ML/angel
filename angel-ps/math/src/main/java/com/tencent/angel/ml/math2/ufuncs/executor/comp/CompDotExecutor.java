	  ...
	  synchronized (CompExecutor.class) {
		if (executor == null) {
		  try {
			...
			String template = "import com.tencent.angel.ml.math2.ufuncs.executor.simple.*;\n" +
					...
					"import com.tencent.angel.ml.math2.ufuncs.executor.comp.CompReduceExecutorClient.*;\n\n" +
