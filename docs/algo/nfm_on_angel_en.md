...
There are many parameters of NFM, which need to be specified by Json configuration file (for a complete description of Json configuration file, please refer to[Json explanation]()), A typical example is:
```json
{
  "data": {
    "format": "dummy",
