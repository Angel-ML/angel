...
- vectorPath: The path is configured as an HDFS path. Each line is composed of node and vector which is nearest neighbor
  candidates of query data.
...
- At about 10 minutes, the task hangs: The most likely reason is that Angel cannot apply for resources! Since BruteForce
