...
## Papers
  ...
  5. Jiawei Jiang, Bin Cui, Ce Zhang, Fangcheng Fu. [DimBoost: Boosting Gradient Boosting Decision Tree to Higher Dimensions](https://dl.acm.org/citation.cfm?id=3196892). SIGMOD, 2018
  6. Jiawei Jiang, Fangcheng Fu, Tong Yang, Bin Cui. [SketchML: Accelerating Distributed Machine Learning with Data Sketches](https://dl.acm.org/citation.cfm?id=3196894). SIGMOD, 2018
