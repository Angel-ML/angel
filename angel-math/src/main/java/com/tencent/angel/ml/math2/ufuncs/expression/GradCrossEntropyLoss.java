...
public class GradCrossEntropyLoss extends Binary {

  public GradCrossEntropyLoss(Boolean inplace) {
    setInplace(inplace);
  ...
  public float apply(float ele1, float ele2) {
    if (ele2 > 0) {
      return -(float) (1.0 / ele1);
    } else {
      return (float) (1.0 / (1.0 - ele1));
    }
  }
  ...
  public long apply(long ele1, long ele2) {
    if (ele2 > 0) {
      return -(long) (1.0 / ele1);
    } else {
      return (long) (1.0 / (1.0 - ele1));
    }
  }
