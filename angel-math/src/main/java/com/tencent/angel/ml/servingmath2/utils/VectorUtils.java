...
package com.tencent.angel.ml.servingmath2.utils;
...
public class VectorUtils {
  ...
  private static SimpleVector emptyLike(SimpleVector v) {
    if (v instanceof IntDoubleVector) {
      ...
      if (((LongDoubleVector) v).isSparse()) {
        ...
        throw new MathException("LongKey dense is not support in emptyLike!");
      }
      ...
      throw new MathException("Dummy is not support in emptyLike!");
    }
  }
  ...
  public static double getDouble(Vector v, long idx) {
    if (v instanceof CompIntDoubleVector) {
      ...
      throw new MathException("Vector is not validate!");
    }
  }
