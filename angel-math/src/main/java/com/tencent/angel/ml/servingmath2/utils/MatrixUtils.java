...
import com.tencent.angel.ml.servingmath2.matrix.BlasDoubleMatrix;
import com.tencent.angel.ml.servingmath2.matrix.BlasFloatMatrix;
import com.tencent.angel.ml.servingmath2.matrix.BlasMatrix;
import com.tencent.angel.ml.servingmath2.matrix.Matrix;
import com.tencent.angel.ml.servingmath2.matrix.RBCompIntDoubleMatrix;
import com.tencent.angel.ml.servingmath2.matrix.RBCompIntFloatMatrix;
...
public class MatrixUtils {
  ...
  public static Matrix emptyLike(Matrix mat) {
    if (mat instanceof BlasMatrix) {
      ...
      throw new MathException("The matrix type is not supported!");
    }
  }
